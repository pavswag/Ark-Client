...
public class CyclesPlugin extends Plugin
{
	...
	{
		Model ashModelData = client.loadModelData(ASH_MODEL);
		Model ashModelData2 = client.loadModelData(ASH_MODEL);
		Model ashModelData3 = client.loadModelData(ASH_MODEL);
		...
		Model cloudModelData = client.loadModelData(CLOUD_MODEL);
		Model cloudModelData2 = client.loadModelData(CLOUD_MODEL);
		Model cloudModelData3 = client.loadModelData(CLOUD_MODEL);
		...
		Model partlyCloudModelData = client.loadModelData(CLOUD_MODEL);
		Model partlyCloudModelData2 = client.loadModelData(CLOUD_MODEL);
		Model partlyCloudModelData3 = client.loadModelData(CLOUD_MODEL);
		...
		Model fogModelData = client.loadModelData(FOG_MODEL);
		...
		Model sandModelData = client.loadModelData(SAND_MODEL);;
		...
		Model snowModelData = client.loadModelData(SNOW_MODEL);;
		Model snowModelData2 = client.loadModelData(SNOW_MODEL);;
		Model snowModelData3 = client.loadModelData(SNOW_MODEL);;
		...
		Model rainModelData = client.loadModelData(RAIN_MODEL);;
		Model rainModelData2 = client.loadModelData(RAIN_MODEL);;
		Model rainModelData3 = client.loadModelData(RAIN_MODEL);;
		...
		Model stormModelData = client.loadModelData(RAIN_MODEL);
		Model stormModelData2 = client.loadModelData(RAIN_MODEL);
		Model stormModelData3 = client.loadModelData(RAIN_MODEL);
		...
		Model starModelData = client.loadModelData(STAR_MODEL);
		Model starModelData2 = client.loadModelData(STAR_MODEL);
		Model starModelData3 = client.loadModelData(STAR_MODEL);
