...
import static net.runelite.client.plugins.weather3d.CyclesConfig.SeasonType.DYNAMIC;
import static net.runelite.client.plugins.weather3d.CyclesConfig.SeasonType.HD_117;
import static net.runelite.client.plugins.weather3d.audio.SoundEffect.*;
