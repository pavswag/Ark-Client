...
public class MiscWidgetManager
{
    ...
    {
        cannonOverlayWidget = parent.createChild(7, WidgetType.GRAPHIC);
        ...
        keyboardWidget = parent.createChild(8, WidgetType.GRAPHIC);
        ...
        inventoryWidget = parent.createChild(9, WidgetType.GRAPHIC);
