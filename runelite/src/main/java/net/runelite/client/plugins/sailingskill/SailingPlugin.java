...
import  net.runelite.client.plugins.sailingskill.npcs.*;
import  net.runelite.client.plugins.sailingskill.overlays.*;
...
import  net.runelite.client.plugins.sailingskill.widgets.*;
