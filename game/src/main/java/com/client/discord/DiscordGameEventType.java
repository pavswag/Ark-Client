...
public enum DiscordGameEventType {
    ...
    TRAINING_HITPOINTS(Skill.HITPOINTS),
    TRAINING_SLAYER(Skill.SLAYER),
    ...
    TRAINING_RUNECRAFT(Skill.RUNECRAFTING),
    TRAINING_HUNTER(Skill.HUNTER),
    TRAINING_DEMONHUNTER(Skill.DEMON_HUNTER),
    TRAINING_FORTUNE(Skill.FORTUNE),
    // Bosses
    ...
    BOSS_HESPORI("Donor/Vote Boss", DiscordAreaType.BOSSES, 5021),
    ...
    BOSS_ZALCANO("CoX Raid Lobby", DiscordAreaType.BOSSES, 12126),
    ...
    REGION_DZ("Donor Zone", DiscordAreaType.REGIONS, 7763),
    ...
    REGION_SCAPERUNE("Random Event", DiscordAreaType.REGIONS, 10058, 7758, 8261),
    ...
    static
    {
        ...
        {
            if (discordGameEventType.regionIds == null)
            {
                continue;
            }

            for (int region : discordGameEventType.regionIds)
            {
    ...
    DiscordGameEventType(String state) {
        this.state = state;
    }
    ...
    DiscordGameEventType(Skill skill) {
        this.state = training(WordUtils.capitalize(skill.name().toLowerCase()));
    }
    private static String training(final String what)
    {
        return "Training: " + what.replace("_", " ");
    }
    ...
    public static DiscordGameEventType fromSkill(final Skill skill)
    {
        switch (skill)
        {
            ...
            case RUNECRAFTING: return TRAINING_RUNECRAFT;
            case HUNTER: return TRAINING_HUNTER;
            case DEMON_HUNTER: return TRAINING_DEMONHUNTER;
            case FORTUNE: return TRAINING_FORTUNE;
            default: return null;
        }
    }
