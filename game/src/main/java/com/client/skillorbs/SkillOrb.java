...
public class SkillOrb {
    ...
    public void draw(int x, int y) {
        ...
        Client.instance.skillOrbs[0].drawAdvancedSprite(x, y, alpha);
        Rasterizer2D.setDrawingArea(60 + y, x + 1, x + 30, (int) (45 - (currentLevel() >= 99 ? 100 : percentProgress)) + 1 + y);
        Client.instance.skillOrbs[1].drawAdvancedSprite(x + 1, 1 + y, alpha);
    ...
    public void drawTooltip() {
        ...
        Client.instance.newSmallFont.drawBasicString(Skills.SKILL_NAMES_ORDER[skill], mouse_Y + 122 / 6 +  Client.instance.newSmallFont.getTextWidth(Skills.SKILL_NAMES_ORDER[skill]) - 25 , mouseY + 20, 16777215, 1);
        ...
        Client.instance.newSmallFont.drawBasicString("Exp Left: @gre@" + nf.format((remainderExp() < 0 ? 0 : remainderExp())), mouse_Y + 5, mouseY + 65, 16777215, 1);
