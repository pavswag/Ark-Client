...
public final class Matrix4f {
    ...
    public Matrix4f(InputBuffer buffer, boolean use4x3) {
    ...
    void lfb(InputBuffer b, boolean c) {
        if (c) {
            Matrix4x3f matrix4x3 = new Matrix4x3f();
            matrix4x3.a1(JagexAngle.mapAngleToTWO_PI(b.readSignedShort()));
            matrix4x3.a2(JagexAngle.mapAngleToTWO_PI(b.readSignedShort()));
            int angle = b.readSignedShort();
            ...
            matrix4x3.a3(theta);
            matrix4x3.a4(((float) (b.readSignedShort())), ((float) (b.readSignedShort())), ((float) (b.readSignedShort())));
            this.sfs(matrix4x3);
        } else {
