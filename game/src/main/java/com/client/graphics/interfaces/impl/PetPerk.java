...
public class PetPerk extends RSInterface {
    ...
    public static void mainInterface(TextDrawingArea[] tda) {
        ...
        addText(48854, "The Vote Genie Pet is a beloved pet on DeadScape, obtaining with a rare chance upon claiming a vote or purchased from the vote store.", tda, 2, 0xff9933, true);
        ...
        for(int i = 25176; i <= 25376; i++) {
            ...
            addText(i, "pet [" + (i - 25176) + "]", tda, 0, 0xff9933, false);
            int yPosition = 3 + (18 * (i - 25176));
