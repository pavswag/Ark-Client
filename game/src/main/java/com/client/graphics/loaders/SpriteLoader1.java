...
public class SpriteLoader1 {
	...
	public static void loadSprites() {
		try {
		    DataInputStream indexFile = new DataInputStream(new GZIPInputStream(new ByteArrayInputStream(FileUtility.readFile(Signlink.getCacheDirectory() + "LIVE/9.idx"))));
		    DataInputStream dataFile = new DataInputStream(new GZIPInputStream(new ByteArrayInputStream(FileUtility.readFile(Signlink.getCacheDirectory() + "LIVE/8.dat"))));
